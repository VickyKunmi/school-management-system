-- CreateEnum
CREATE TYPE "ExeatStatus" AS ENUM ('PENDING', 'APPROVED', 'REJECTED');
...
-- AddForeignKey
ALTER TABLE "Exeat" ADD CONSTRAINT "Exeat_studentId_fkey" FOREIGN KEY ("studentId") REFERENCES "Student"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
